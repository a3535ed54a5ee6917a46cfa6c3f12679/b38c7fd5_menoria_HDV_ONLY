...
public class GuiTextField extends Gui
{
    ...
    public GuiTextField(FontRenderer par1FontRenderer, int par2, int par3, int par4, int par5, boolean hideContent, String defaultText) {
    	this(par1FontRenderer, par2, par3, par4, par5);
    ...
    public void drawTextBox()
    {
        if (this.func_146176_q())
        {
            ...
            if (var4.length() > 0)
            {
                ...
                if (this.hideContent && (this.defaultText != null && !var10.equalsIgnoreCase(this.defaultText))) {
                	var10 = StringUtils.repeat('*', var10.length());
                }
            ...
            {
                if (this.hideContent && (this.defaultText != null && !var4.equalsIgnoreCase(this.defaultText))) {
                	var4 = StringUtils.repeat('*', var4.length());
                }
